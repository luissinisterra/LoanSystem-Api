...
public class LoanController {
    ...
    public ResponseEntity<List<Loan>> getAllLoansByClientId(@PathVariable int userId) throws NotFoundException {
        List<Loan> clientLoans = this.iLoanService.getAllLoansByClientId(userId);
    ...
    @PostMapping
    public ResponseEntity<Loan> createLoan(@RequestBody LoanDTO newLoan) throws IncompleteDataException, NotFoundException {
        if (newLoan == null) {
